...
bussiness <- top_schools_percentage |>
  ...
  labs(x = "", y = "", 
       ...
       subtitle = "These top schools take 22% of the Total scholarships awarded in Business  assessed (291)" )+
  theme(axis.text.x = element_blank(),  # Remove y-axis tick labels
        axis.ticks.x = element_blank(),
        axis.text.y = element_text(size = 24), 
        plot.title = element_text(hjust = 0, size = 32, face = "bold"),
...
ggsave("business.jpg", plot = bussiness, width = 12, height = 8, units = "in", dpi = 200)
